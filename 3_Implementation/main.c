...

{
    ...
    if ((choose_type == 'T') || (choose_type == 't'))
    {
        ...
        if (temp_Choice == 1)
        {
            ...
            printf("Equivalent Celcius is:%2f\n", usroutputC);
        }
        else if (temp_Choice == 2)
        {
            ...
            printf("Equivalent Fahrenheit is:%2f\n", usroutputF);
        }
        ...
        else if (temp_Choice == 4)
        {
            ...
            printf("Equivalent Kelvin value is:%2f\n", usroutputK);
        }
...

    {
        ...
        if (currency_Choice == 1)
        {
            ...
            printf("Equivalent Euro value is:%2f\n", usroutputUSDtoEuro);
        ...
        else if (currency_Choice == 2)
        {
            ...
            printf("Equivalent JPY value is:%2f\n", usroutputUSDtoJPY);
        }
        else if (currency_Choice == 3)
        {
            ...
            printf("Equivalent RMB value is:%2f\n", usroutputUSDtoRMB);
        }
        else
...

    {
        ...
        if (mass_Choice == 1)
        {
            ...
            printf("Equivalent Pound value is:%2f\n", usroutputPound);
        }
